...
document.querySelectorAll('.tambah-keranjang').forEach(button => {
    button.addEventListener('click', function() {
        var idPakaian = this.getAttribute('data-id');
        var namaPakaian = this.getAttribute('data-nama');
        var asalPakaian = this.getAttribute('data-asal');
        var harga = parseFloat(this.getAttribute('data-harga'));
        var jumlah = parseInt(document.getElementById('jumlah-' + idPakaian).value);
        ...
        xhr.send("tambah_ke_keranjang=true&id_pakaian=" + idPakaian + "&nama_pakaian=" + namaPakaian + "&asal_pakaian=" + asalPakaian + "&harga=" + harga + "&jumlah=" + jumlah);
    });
});
